...
- **Catalogue:** the Masterwork base grades — **Breastplate**, **Full Plate**, and the **Buckler** — at list + surcharge, with both Quality menus authored in [masterwork.md](masterwork.md). The named goods are the **Plattnerhalle Breastplate**, **Plattnerhalle Full Plate**, and **Plattnerhalle Buckler** — the hall's name leading, on the Mantlethorn Leather / Temper Quenched pattern (settled Aug 18 2026).
