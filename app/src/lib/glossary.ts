...
export const GLOSSARY: Record<string, string> = {
  ...
  'Primary Attribute': 'A key attribute granted by your Class — one of the two attributes that can climb past +2.',
  'Secondary Attribute': 'A key attribute granted by your Path — the second attribute that can climb past +2.',
  'key attributes': 'Your Primary and Secondary attributes — the only two that can exceed +2 (reaching +3, then +4 at 5th level and +5 at 10th).',
  ...
  'Class': 'Your character’s vocation — it sets your Primary Attribute, an Ability Category, Class HP, skills, and proficiencies.',
  'Path': 'A specialisation within your Class — it adds your Secondary Attribute, a second Ability Category, more Class Skills, and more proficiencies.',
