...
Almost everything you buy in Avilund is built the same way: as a **Ladder**. A Ladder is a short track of escalating effect, and each step on it is a **Rank**. You start at the bottom and climb — and climbing costs Advances.

The pattern is consistent enough to learn once and apply everywhere:

- **Rank 1** is the base, and usually comes free with the thing it sits on.
